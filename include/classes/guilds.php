	...
	public function dataview($query, $search=NULL)
	{
		...
		if($rowCount>0)
		{
			...
			<tr>
				...
				<td><img src="<?php print $site_url; ?>assets/images/empire/<?php print $empire=get_player_empire(getAccountID($row['master'])); ?>.jpg" alt="<?php print emire_name($empire); ?>" title="<?php print emire_name($empire); ?>"></td>
	...
	{		
		...
		if($total_no_of_records > 0)
		{
			...
			if($current_page!=1)
			{
				...
				if($search)
				{
					print "<a class='page-link' href='".$self."1/".$search."'>".$first."</a>&nbsp;&nbsp;";
					print "<a class='page-link' href='".$self.$previous."/".$search."'>&laquo;</a>&nbsp;&nbsp;";
				}
				else
				{
					print "<a class='page-link' href='".$self."1'>".$first."</a>&nbsp;&nbsp;";
					print "<a class='page-link' href='".$self.$previous."'>&laquo;</a>&nbsp;&nbsp;";
				}
			}
			...
			for($i=$x;$i<=$x+3;$i++)
				...
				{
					if($search)
						print "<a class='page-link panel-button-active' href='".$self.$i."/".$search."'>".$i."</a>&nbsp;&nbsp;";
					else
						print "<a class='page-link panel-button-active' href='".$self.$i."'>".$i."</a>&nbsp;&nbsp;";
				}
				...
				{
					if($search)
						print "<a class='page-link' href='".$self.$i."/".$search."'>".$i."</a>&nbsp;&nbsp;";
					else
						print "<a class='page-link' href='".$self.$i."'>".$i."</a>&nbsp;&nbsp;";
				}
			...
			if($current_page!=$total_no_of_pages)
			{
				$next=$current_page+1;
				if($search)
					print "<a class='page-link' href='".$self.$next."/".$search."'>&raquo;</a>&nbsp;&nbsp;";
				else
					print "<a class='page-link' href='".$self.$next."'>&raquo;</a>&nbsp;&nbsp;";
