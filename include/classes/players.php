	...
	public function dataview($query, $search=NULL)
	{
		...
		if($rowCount>0)
		{
			...
			<tr>
				...
				<td><img src="<?php print $site_url; ?>assets/images/empire/<?php print $empire=get_player_empire($row['account_id']); ?>.jpg" alt="<?php print emire_name($empire); ?>" title="<?php print emire_name($empire); ?>"></td>
		...
		if($total_no_of_records > 0)
		{
			...
			if($current_page!=1)
			{
				...
				if($search)
				{
					...
					print "<a class='page-link  larger' href='".$self.$previous."/".$search."'>&laquo;</a>&nbsp;&nbsp;";
				}
				else
				{
