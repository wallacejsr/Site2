<div class="page">
	<div class="container">
		<h1 class="page-title"><?php if($message==7) print $lang['change-password']; else print $lang['account-recovery']; ?></h1>
		...
		<div class="panel">
			<div class="row">
				...
				<input type="submit" value="<?php if($message==7) print $lang['change-password']; else print $lang['account-recovery']; ?>" class="nav-link nav-link-button" tabindex="7">
			<?php } ?>
            </form>
