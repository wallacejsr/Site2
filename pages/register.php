<div class="page">
	<div class="container">
		<h1 class="page-title"><?php print $lang['register']; ?></h1>
		...
		<div class="panel-login">
			<div class="row">
				...
				?>
							...
							<input class="form-control" name="email" id="email" pattern=".{7,64}" maxlength="64" placeholder="ex@test.com" required="" type="email">
							<div class="clearfix"></div>
							<?php print '<img src='.$_SESSION['captcha']['image_src'].'>'; ?>
							<div class="clearfix"></div>
							<input class="form-control" name="captcha" pattern=".{4,6}" maxlength="5" placeholder="<?php print $lang['captcha-code']; ?>" required="" type="text">
							<div class="clearfix"></div>
							<center><input type="submit" value="<?php print $lang['register']; ?>" class="panel-login-submit" tabindex="7"><center>
            </form>
			<?php } else { ?>
